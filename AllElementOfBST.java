class AllElementOfBST 
{
	{//BST property is not  used here 
    PriorityQueue<Integer> pq= new PriorityQueue<>();//We are using the default natural sorting order, to sort the value 
    ...
    {//simple inorder, inorder of BST is always sorted 
        ...
        return;//all function complete deleting this activation record and returning to the parent 
    }
}
